...
const Playas: React.FC = () => {
    ...
    //     const imgOfBeach = document.getElementsByClassName("'divImgBeach'") as HTMLCollectionOf<HTMLDivElement>;

    //     for (let i = 0; i < imgOfBeach.length; i++) {
    //         const element = imgOfBeach[i];
    //         element.addEventListener('click', () => { nameOfBeach[i].style.display = "block" })
    //     }
    // }
            ...
            <Box width={{ base: '60%', sm: '100%', md: '100%', lg: '100%' }} display="flex" marginTop='' flexDirection='column' height='100vh' id='section0'>
                <Box display='flex' justifyContent='space-evenly' gap='1' width='100%'>
                    <Box className='divImgBeach' width='17%' display='flex' justifyContent='center' alignItems='center'>
                        <Box className='nombrePlaya' color='white' fontSize='3xl' position='absolute' zIndex='1'>Playa La Aldea</Box>
                    ...
                    <Box className='divImgBeach' width='17%' display='flex' justifyContent='center' alignItems='center'>
                        <Box className='nombrePlaya' color='white' fontSize='3xl' position='absolute' zIndex='1'>Playa Tasarte</Box>
                    ...
                    <Box className='divImgBeach' width='17%' display='flex' justifyContent='center' alignItems='center'>
                        <Box className='nombrePlaya' color='white' fontSize='3xl' position='absolute' zIndex='1'>Playa Tasartico</Box>
                    ...
                    <Box className='divImgBeach' width='17%' display='flex' justifyContent='center' alignItems='center'>
                        <Box className='nombrePlaya' color='white' fontSize='3xl' position='absolute' zIndex='1'>Playa de Guguy </Box>
                    ...
                    <Box className='divImgBeach' width='17%' display='flex' justifyContent='center' alignItems='center'>
                        <Box className='nombrePlaya' color='white' fontSize='3xl' position='absolute' zIndex='1'>Playa el Puerto</Box>
            ...
            {Object.entries(playasInfo).map((value, index) => {
                return (
                    <Box display='flex' justifyContent='center' boxSize="xxl" height="100vh" id={`section${index + 1}`} key={value[1].title}>
                        ...
                        <Box display='flex' flexDirection='column' alignItems='center' marginTop='5%' width="50%">
                            <Heading fontFamily='Oswald' marginBottom="30px" marginTop="20px">{value[1].title}</Heading>

                            <Image width="85%" height="fit-content" src={value[1].src}></Image>
                        </Box>
