...
const Cultura: React.FC = () => {
    const [currentSectionCultura, setCurrentSectionCultura] = useState<number>(0);
    const sectionIds: string[] = useMemo(() => ['section0', 'section1', 'section2', 'section3', 'section4'], []);

    useEffect(() => {
        console.log('Sections mounted');
    }, []);

    const scrollToSectionCultura = useCallback((index: number) => {
        console.log(`Scrolling to section: ${sectionIds[index]}`);
    ...
    const handleWheelEventCultura = useCallback((e: React.WheelEvent) => {
        console.log(`Wheel event deltaY: ${e.deltaY}`);
        if (e.deltaY > 0) {
            console.log('Scrolling down');
            if (currentSectionCultura < sectionIds.length - 1) {
                const nextSectionCultura = currentSectionCultura + 1;
                setCurrentSectionCultura(nextSectionCultura);
                scrollToSectionCultura(nextSectionCultura);
            }
        } else {
            console.log('Scrolling up');
            if (currentSectionCultura > 0) {
                const prevSectionCultura = currentSectionCultura - 1;
                setCurrentSectionCultura(prevSectionCultura);
                scrollToSectionCultura(prevSectionCultura);
            }
        }
    }, [currentSectionCultura, scrollToSectionCultura, sectionIds]);


    return (
        <Box onWheel={handleWheelEventCultura}>
            <Box height='100vh'  className='section0'>
            ...
            <Box height='100vh' className='section1'>
            ...
            <Box height='100vh' className='section2'>
            ...
            <Box height='100vh' className='section3'>
            ...
            <Box height='100vh' className='section4'>
